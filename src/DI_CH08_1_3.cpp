...
{
    ifm_o3m_AlgoIFOutput_DIA1_1_3* res = (ifm_o3m_AlgoIFOutput_DIA1_1_3*)buffer;
    if( (!buffer) || (bufferSize != 19224) || (sizeof(ifm_o3m_AlgoIFOutput_DIA1_1_3) != 19224) )
    {
        return 0;
    }
    if ( ! ( (res->magic_no[0] == 'O' ) && (res->magic_no[1] == '3' ) && (res->magic_no[2] == 'M' ) && (res->magic_no[3] == '!') &&
             ...
             (res->version[0] == 1) && (res->version[1] == 3  ) ) )
    {
        return 0;
    }
